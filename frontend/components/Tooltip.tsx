...
export function Tooltip({ content, children, position = "top" }: TooltipProps) {
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          className={`absolute z-50 px-3 py-2 text-sm text-white bg-gradient-to-br from-red-900 to-red-950 rounded-lg shadow-xl border border-red-800 whitespace-nowrap pointer-events-none transition-all duration-200 ${positionClasses[position]}`}
        >
          {content}
          <div
